...
public final class Config
{
	...
	//singto
	public static double DEFENDER_PDEFENCE_MULTIPLIER;
	public static double DEFENDER_MDEFENCE_MULTIPLIER;
	public static double DEFENDER_PATTACK_MULTIPLIER;
	public static double DEFENDER_MATTACK_MULTIPLIER;
	//singto
	...
	public static double[] MOONLAND_EXPERIENCE_RATE_MULTIPLIER = {
			...
			1.0, // Level 39
			4.0, // Level 40
			4.0, // Level 1 Chaque level +2 auparavant
			4.0, // Level 2
			5.0, // Level 3
			5.0, // Level 4
			5.0, // Level 5
