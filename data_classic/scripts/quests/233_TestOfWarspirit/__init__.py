...
DROPLIST = {
    ...
    20581: [[2, 3, 4, 5, 6], "Perkiron", 1, 50,
            [TONARS_RIB_BONE, TONARS_SPINE, TONARS_ARM_BONE, TONARS_SKULL, TONARS_THIGH_BONE]],
    20582: [[2, 3, 4, 5, 6], "Perkiron", 1, 50,
            [TONARS_SKULL, TONARS_ARM_BONE, TONARS_RIB_BONE, TONARS_SPINE, TONARS_THIGH_BONE]],
    20158: [[2, 3, 4, 5], "Manakia", 1, 100,
            [HERMODTS_RIB_BONE, HERMODTS_SPINE, HERMODTS_ARM_BONE, HERMODTS_THIGH_BONE]],
    20089: [[4, 5, 6, 7, 8, 9], "Racoy", 1, 100,
            [[KIRUNAS_THIGH_BONE, KIRUNAS_ARM_BONE], [KIRUNAS_SPINE, KIRUNAS_RIB_BONE], [KIRUNAS_SKULL]]],
    20090: [[4, 5, 6, 7, 8, 9], "Racoy", 1, 100,
            [[KIRUNAS_THIGH_BONE, KIRUNAS_ARM_BONE], [KIRUNAS_SPINE, KIRUNAS_RIB_BONE], [KIRUNAS_SKULL]]]
}
        ...
        # if quest is accepted and in progress
            ...
            # Orim and his Part, he sends you out to hunt Portas, Mordeos and Excuros
                ...
                if Orim == 1:
                    ...
                    if st.getQuestItemsCount(2887) and st.getQuestItemsCount(2901) and st.getQuestItemsCount(
                            2910) and st.getQuestItemsCount(2894):
                        st.set("cond", "2")
                    st.set("Orim", "6")
                else:
